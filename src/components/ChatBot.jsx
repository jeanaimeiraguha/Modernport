...
const KB = [
  ...
  },
  {
    ...
    answer: "You can view and download my full CV at the /cv page — there's a CV button in the navbar at the top.\n\nIt covers my full work history, education, skills, and certifications.",
  },
  {
  ...
  },
  {
    ...
    answer: "A few things people have said:\n\n\"The kind of CTO every startup dreams of\" — Mugisha Eric, CEO Igifu Meals\n\n\"Delivered a fintech dashboard processing $2M+ without a single critical bug\" — Uwimana Claire, PM\n\n\"Code so readable that onboarding new engineers took half the usual time\" — Nkurunziza David, Lead Engineer\n\nMore in the Testimonials section.",
  },
  {
